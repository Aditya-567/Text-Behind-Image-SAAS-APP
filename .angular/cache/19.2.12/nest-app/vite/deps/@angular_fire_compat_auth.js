...
import {
  ...
  ɵlazySDKProxy,
  ɵzoneWrap
} from "./chunk-5VPKEXZV.js";
import "./chunk-TUAU73W2.js";
import {
  Component,
  Deferred,
  ErrorFactory,
  ...
  registerVersion,
  setLogLevel
} from "./chunk-GVU77N67.js";
import {
  isPlatformServer
} from "./chunk-IRUEBJJ6.js";
import {
  EnvironmentInjector,
  Inject,
  Injectable,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name2, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-6L6HC74A.js"))), map(() => ɵfirebaseAppFactory(options, zone, name2)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
